...
func TestCreateService(t *testing.T) {
	...
	service, err := ComposeService(&serviceImage, "TEST_SERVICECREATION", "ALIAS", nil, nil, nil)
	if err != nil {
...
func TestRemoveService(t *testing.T) {
	...
	service, err := ComposeService(&serviceImage, "TEST_SERVICEDELETE", "TEST_SERVICEDELETE", nil, nil, nil)
	if err != nil {
		t.Errorf("Error creating service : %s", err)
	}
