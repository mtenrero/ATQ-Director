...
import (
	...
	"github.com/mtenrero/ATQ-Director/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "ATQ - Director-cli",
		Short: `CLI client for the ATQ - Director service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "atq.mtenrero.com", "API hostname")
	...
	c.UserAgent = "ATQ - Director-cli/0"
